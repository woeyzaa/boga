...
async function fetchCookies() {
    try {
        const response = await axios.get('https://raw.githubusercontent.com/woeyzaa/boga/refs/heads/main/samsu.json');
...
const levelOrder = ['Bronze', 'Silver', 'Gold', 'Ultimate'];
...
async function checkProductStatus() {
    try {
        ...
        $('.row.mt-1.gy-3 .col-6.col-md-4').each((index, element) => {
            ...
            const isOutOfStock = productName === 'Quiksilver Stitchy 3 Wallet' ||
                productName === 'Torch Dompet Kartu - Wallet Pasport Pouch Clutch Card Holder HP Hachu - Black' ||
                productName === 'Humblezing Slingbag Tango Pouch - BLACK' ||
                productName === 'JBL C150SI Black In-Ear Earphone cable with Mic' ||
                productName === 'Xiaomi Official Redmi Buds 4 Active - Hitam' ||
                productName === 'Xiaomi Official Redmi Power Bank 10.000mAh Dual Output Type A - Black' ||
                productName === 'Obermain Norman Cardholder' ||
                productName === 'NESPRESSO Nomad Travel Mug Small' ||
                productName === 'JBL Go 2 Portable Speaker Bluetooth' ||
                productName === 'Thule Lithos22 Tas Laptop Backpack 16L TLBP 213 - Black' ||
                productName === 'Mosh New Latte Mug Cup Black 430ml';
